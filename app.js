const STORE_KEY = "starquiz_v9_premium_fixed_state";
...
function renderHome(){
 ...
 <section class="card hero">
   <img class="logo-main" src="./assets/logo.png" alt="StarQuiz" onerror="this.onerror=null;this.src='./logo.png';">SQ</div>'">
 ...
 <section class="card"><h2>V9 Premium</h2><p class="muted">STARQUIZ logosu sabitlendi, mobil ikonlar güncellendi, Kolay / Orta / Zor testler ve konu bazlı çalışma korundu.</p></section>`;
}
function renderExam(){
...
function finishQuiz(){
 ...
 save();
 app.innerHTML=`<section class="card hero"><img class="logo-main" src="./assets/logo.png" alt="StarQuiz" onerror="this.onerror=null;this.src='./logo.png';">SQ</div>'"><h2>Sonuç</h2>
...
function renderStats(){
 ...
 app.innerHTML=`<section class="card hero"><img class="logo-main" src="./assets/logo.png" alt="StarQuiz" onerror="this.onerror=null;this.src='./logo.png';">SQ</div>'"><h2>Analiz</h2><div class="grid"><div class="stat">Toplam Soru <b>${state.total}</b></div><div class="stat">Doğru <b>${state.correct}</b></div><div class="stat">Yanlış <b>${state.wrong}</b></div><div class="stat">Başarı <b>%${rate}</b></div></div></section>
